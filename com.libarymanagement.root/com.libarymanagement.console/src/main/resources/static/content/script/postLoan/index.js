...
var vm = new Vue({
    ...
    beforeCreate:function(){
        ...
        model.searchObj.searchDateType='ind_date_time';
        model.searchObj.searchDateSt=new Date().toLocaleDateString().replace(/\//g,"-");
        model.searchObj.searchDateEnd=new Date().toLocaleDateString().replace(/\//g,"-");
    },
    //初始化远程数据
    created:function(){
        this.search();
